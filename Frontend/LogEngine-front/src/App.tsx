...
function App() {
  ...
  return (
    ...
    <div className="flex ">
      {/* Titre */}
        <img className="h-auto max-w-50" src="./src/assets/LogEngine_logo.png" alt="image description"/>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white" >LogEngine</h1>   

    </div>
    {/* Section pour ajouter un log */}
   
            <form className="flex flex-col gap-4 p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Envoyer un log</h2>

                    <input 
                        type="text"
                        name="message"
                        id="msg"
                        className="block min-w-0 grow py-1.5 pr-3 pl-1 text-base  bg-gray-50 rounded-lg border   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <select id="level" className="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 ">
            ...
            <button type="submit" className="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Envoyer</button>
